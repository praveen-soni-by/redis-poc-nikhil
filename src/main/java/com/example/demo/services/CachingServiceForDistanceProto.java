...
@Service
@Log4j2
public class CachingServiceForDistanceProto {

    private final DistanceProtoRepository distanceProtoRepository;

    public CachingServiceForDistanceProto(DistanceProtoRepository distanceProtoRepository) {
